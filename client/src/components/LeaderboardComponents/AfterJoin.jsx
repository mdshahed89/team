  ...
  return (
    <div>
        ...
        <div className=' flex items-center justify-center gap-5 mt-10 '>
            <div>
                <img src={ProfileImg} alt="" className=' w-[8rem] h-[8rem] object-cover rounded-full ' />
                <div>
            ...
            <div>
                <img src={ProfileImg} alt="" className=' w-[8rem] h-[8rem] object-cover -mt-[80%] rounded-full ' />
                <div>
