        ...
        <h3 className=' text-[#fff] text-[2rem] font-bold mb-4 '>My Wallet</h3>
        {
          ...
          <div>
            ...
            <div className=' flex items-center gap-5 mt-5 '>
              <div>
                <button className=' text-[1.3rem] px-8 font-semibold py-2 rounded-md bg-slate-700 text-[#fff] '><Payment title="Withdraw" typ="withdraw" /></button>
              </div>
              <div>
              <button className=' text-[1.3rem] px-8 font-semibold py-2 rounded-md bg-blue-700 text-[#fff] '><Payment title="Deposit" typ="deposit" /></button>
              </div>
            </div>
          </div> : 
