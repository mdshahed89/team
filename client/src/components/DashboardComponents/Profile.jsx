  ...
  return (
    <div>
      <div className=' flex flex-col items-center gap-5   '>
        ...
        <input onChange={handleFileChange} type="file" ref={fileRef} hidden name="" id="" />
      ...
      <div>
        ...
        <form onSubmit={handleSubmit} className=' text-[1.3rem] flex flex-col gap-3 '>
          ...
          <div className=' flex-1 flex flex-col gap-1 text-[#585858] '>
            ...
            <input type="text" readOnly id='firstName' value={currentUser?.firstName} placeholder='First Name' className=' font-semibold outline-none py-2 px-3 w-full border rounded-md bg-blue-500/20 text-[#2e2e2e] placeholder:text-[#686868] ' />
          </div>
          <div className=' flex-1 flex-col flex gap-1 text-[#585858] '>
            <label htmlFor="">Last Name</label>
            <input type="text" readOnly id='lastName' value={currentUser?.lastName} placeholder='Last Name' className=' font-semibold outline-none py-2 px-3 w-full border rounded-md bg-blue-500/20 text-[#2e2e2e] placeholder:text-[#686868] ' />
          </div>
          </div>
          ...
          <div className=' flex flex-col gap-1 text-[#585858] '>
            ...
            <input onChange={handleChange} id='password' type="password" placeholder='New Password' className=' font-semibold outline-none py-2 px-3 w-full border rounded-md bg-blue-500/20 text-[#2e2e2e] placeholder:text-[#686868] ' />
          </div>
          <div className=' flex flex-col gap-1 text-[#585858] '>
